...
Wishlist lookup resolves numeric IDs and exact canonical names through database indexes before searching aliases and partial names. Exact canonical names take precedence over aliases. Duplicate canonical names remain ambiguous; select a character by ID.
