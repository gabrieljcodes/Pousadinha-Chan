...
func init() {
	...
	SlashCommands = append(SlashCommands,
		...
		&discordgo.ApplicationCommand{Name: "search", Description: locale.Text("commands.discovery.search"), DMPermission: &dm, Options: []*discordgo.ApplicationCommandOption{{Type: discordgo.ApplicationCommandOptionString, Name: "query", Description: locale.Text("commands.discovery.query"), Required: true}, page()}},
