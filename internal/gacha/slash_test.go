...
func TestSlashRequestMapping(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"wishclear", nil, "wishclear", "", 1},
		{"wishlist", []*discordgo.ApplicationCommandInteractionDataOption{str("action", "wishclear")}, "wishclear", "", 1},
		{"wish", []*discordgo.ApplicationCommandInteractionDataOption{str("character", "1, 2; Emilia")}, "wish", "1, 2; Emilia", 1},
